      ...
      <div className="max-w-4xl mx-auto bg-background rounded-lg shadow-lg p-8 border border-border">
        ...
        <div className="prose max-w-none">
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              Any consequences resulting from the loss or unauthorized access to their note links
            </li>
          </ul>

          <h2 className="text-xl font-semibold mb-4">3. Disclaimer of Warranties</h2>
          <p className="mb-6">
            Onion Note and its operators make no warranties, express or implied, and hereby disclaim
            and negate all other warranties, including without limitation, implied warranties or
            conditions of merchantability, fitness for a particular purpose, or non-infringement of
            intellectual property or other violation of rights.
          </p>
          <p className="mb-6">
            In no event shall Onion Note or its operators be liable for any damages (including,
            without limitation, damages for loss of data or profit, or due to business interruption)
            arising out of the use or inability to use the materials on Onion Note's website or
            service, even if Onion Note or an authorized representative has been notified orally or
            in writing of the possibility of such damage.
          </p>

          <h2 className="text-xl font-semibold mb-4">4. Limitation of Liability</h2>
          <p className="mb-6">
            Onion Note shall not be liable for any direct, indirect, incidental, special,
          ...
          <p className="mb-6">
            Onion Note reserves the right to modify or discontinue, temporarily or permanently, the
          ...
          <p className="mb-6">Users are prohibited from using the service to:</p>
          <ul className="list-disc pl-6 mb-6">
            <li>
              Transmit any material that is illegal, harmful, threatening, abusive, harassing,
          ...
          <p className="mb-6">
            Currently, Onion Note does not use any cookies. If we implement cookie usage in the
            future, we will update this policy and notify users of any changes.
          </p>
          ...
          <p className="mb-6">
            Onion Note reserves the right to modify these terms at any time. We will notify users of
            any material changes by posting the new terms on this page. Your continued use of the
            service after such modifications will constitute your acknowledgment of the modified
            terms.
          </p>
        </div>
      </div>
